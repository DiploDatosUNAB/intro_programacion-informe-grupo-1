...
unique(victimas$fecha_detencion_secuestro)
#Resumen de variables 
summary(victimas)

table(victimas$anio_desaparicion)

unique(victimas$anio_desaparicion)
```
...
freq_prov_cons <- merge(x = frecuencia_provincia, y = censo_1980, by = "Provincia")
...
Hay 575 NA en provincia

389 "sin datos"

datos resguardados 53
